...
```mermaid
graph TD
    A[01. Loop Basics] --> B[02. Prefix Sum]
    B --> C[03. Two Pointers]
    C --> D[04. Sliding Window]
    D --> E[05. Hashing & Frequency]
    E --> F[06. String Patterns]
    F --> G[07. Matrix Traversal]
    G --> H[08. Binary Search]
    H --> I[11. Linked Lists]
    I --> J[12. Stacks & Queues]
    J --> K[10. Heaps & Priority Queues]
    K --> L[13. Trees & BST]
    L --> M[14. Graphs]
    M --> N[15. Backtracking]
    N --> O[17. Tries]
    O --> P[09. Greedy]
    P --> Q[16. Dynamic Programming]
    Q --> R[18. Bit Manipulation]
```
...
8. **[08_binary_search/binary_search.py](file:///e:/Learnings/Python-Coding/python_interview_patterns/08_binary_search/binary_search.py)** - O(log N) search on sorted spaces.
...
13. **[14_graphs/graphs.py](file:///e:/Learnings/Python-Coding/python_interview_patterns/14_graphs/graphs.py)** - Dijkstra, Topological Sort, Cycle Detection.
...
17. **[16_dynamic_programming/dynamic_programming.py](file:///e:/Learnings/Python-Coding/python_interview_patterns/16_dynamic_programming/dynamic_programming.py)** - Memoization, Tabulation, Knapsack, LIS.
...
```mermaid
graph TD
    A[01. Basic Select & Filtering] --> B[02. Joins]
    B --> C[03. Aggregations & Grouping]
    C --> D[04. Subqueries & CTEs]
    D --> E[05. Window Functions]
    E --> F[06. Senior SQL Optimization & Design]
```
